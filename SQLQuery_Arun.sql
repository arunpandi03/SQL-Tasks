 ...
 (5,'Punitha','Arun', 30000, 3,'03/19/2018','02/10/2021'),
 (6,'Sandiya','Kumar', 15000, 2,'04/19/2009','05/8/2012'),
 (7,'Surya','Prakash', 45000, 4,'06/19/2019','05/8/2012'),
 (8,'Arun','Kumar', 55000, 3,'07/20/2013','10/6/2015'),
 (9,'Sathya','priya', 10000, 5,'06/9/2020','11/21/2022'),
 (10,'Keerthi',' Balan', 18000, 2,'2/25/2013','01/28/2018'),
 (11,'Ganesh','Pandiyan', 30000, 4,'07/09/2016','1/08/2020'),
 (12,'Saranya','Saran', 12000, 4,'07/09/2016','1/08/2020'),
 (13,null,null, 20000, 4,'07/09/2016','1/08/2020')
...
--QUERIES FOR GIVEN QUESTIONS: 
 ...
 -- primary key is a key which is given to column that contain unique values and no null values
 ...
 --foreign key is a key refers primary key data of another table also given to column that accept multiple null  .
 CREATE TABLE ARUNPANDI_DEPARTMENTS
 (
 DEPARTMENT_ID INT PRIMARY KEY,
 MANAGER_ID INT,
 ...
 create view ARUNPANDI_VIEW  as select ID,FIRST_NAME,LAST_NAME,a.DEPARTMENT_ID,DEPARTMENT_NAME from  ARUNPANDI_EMPLOYEES as a inner join  ARUNPANDI_DEPARTMENTS as d
 on d.DEPARTMENT_ID=a.DEPARTMENT_ID ;
 select *from ARUNPANDI_VIEW
 ...
 select replace('2006-12-30','-','') + replace(' 00:38:54',':','');	
